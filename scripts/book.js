...
function Book(obj) {
  ...
  this.author = obj.volumeInfo.hasOwnProperty('author') ? obj.volumeInfo.authors[0] : 'No Author Available';
  this.description = obj.volumeInfo.hasOwnProperty('description') ? obj.volumeInfo.description : 'No Description Available';
  let regex = /^https/;
  let thumbUrl = obj.volumeInfo.hasOwnProperty('imageLinks.thumbnail') ? obj.volumeInfo.imageLinks.thumbnail : 'https://images.pexels.com/photos/2340254/pexels-photo-2340254.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260';
